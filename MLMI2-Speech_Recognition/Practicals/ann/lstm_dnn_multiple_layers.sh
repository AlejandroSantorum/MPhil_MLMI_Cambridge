...
do
    # Training
    ../tools/steps/step-dnntrain -MODELINI ../new_nn_models/lstm/LSTM-1L-DNN-${n_layers}L.FBANK_D_A_Z.ini -GPUID 0 -vvv ../convert/fbk25d/env/environment_D_A_Z $pracgmmexp/align-mono-hmm84/align/timit_train.mlf $pracgmmexp/mono/hmm84/MMF $pracgmmexp/mono/hmms.mlist ${store_folder}/LSTM-1L-DNN-${n_layers}L-FBK_D_A_Z/dnntrain
