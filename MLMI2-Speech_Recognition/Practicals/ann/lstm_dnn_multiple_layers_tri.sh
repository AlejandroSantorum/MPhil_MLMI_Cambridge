...
if ! [ -d "$ALIGN_DIR" ]; then
    ...
    ../tools/steps/step-align $PWD/FBK_D_Z_FlatStart/${gmm_triphone_file} hmm84 FBK_D_Z_FlatStart/align-xwtri-hmm84
fi
...
do
    # Training
    ../tools/steps/step-dnntrain -MODELINI ../new_nn_models/lstm/LSTM-1L-DNN-${n_layers}L.FBANK_D_Z.ini -GPUID 0 -vvv ../convert/fbk25d/env/environment_D_Z $pracgmmexp/align-xwtri-hmm84/align/timit_train.mlf $pracgmmexp/${gmm_triphone_file}/hmm84/MMF $pracgmmexp/${gmm_triphone_file}/hmms.mlist ${store_folder}/LSTM-1L-DNN-${n_layers}L-FBK_D_Z/dnntrain
